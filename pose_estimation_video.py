...
def analyze_video(video_path):
    ...
    FRAME_SKIP = 5
    pushup_counter, squat_counter, jumping_jack_counter = 0, 0, 0
    pushup_stage, squat_stage, jumping_jack_stage = None, None, None
    ...
    while cap.isOpened():
        ...
        if results.pose_landmarks:
            ...
            if angle_elbow_l > 160: pushup_stage = "down"
            ...
            if angle_knee_r > 160: squat_stage = "up"
            ...
            if landmarks[mp_pose.PoseLandmark.LEFT_WRIST.value].y > landmarks[mp_pose.PoseLandmark.LEFT_HIP.value].y and jumping_jack_stage == 'up':
                jumping_jack_stage = "down"
                jumping_jack_counter += 1
    
    cap.release()
    return {
        "frame_count": frame_count, "detected_frames": detected_frames,
        "pushups": pushup_counter, "squats": squat_counter, "jumping_jacks": jumping_jack_counter
    }
